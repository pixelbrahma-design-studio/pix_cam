...
import 'package:pix_cam/domain/weekly/i_weekly_repository.dart' as _i5;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i5.IWeeklyRepository>(() => _i6.WeeklyRepository());
    gh.factory<_i7.WeeklyWatcherBloc>(
        () => _i7.WeeklyWatcherBloc(gh<_i5.IWeeklyRepository>()));
    gh.factory<_i8.HourlyWatcherBloc>(
        () => _i8.HourlyWatcherBloc(gh<_i3.IHourlyRepository>()));
    return this;
  }
}
